...
手で回すだけなら 1 日、自動起動まで入れて 2 日でした。Antigravity CLI はアカウントのログインで動き、API キーは渡していません。無料プランで始められ、従量課金も発生しません（上限に当たったら待ちます）。
...
| 日付 | 見せたもの | 指摘 | 当たり |
|---|---|---|---|
| 2026-09-13 | リポジトリ全体 | 18 件 | 8 件 |
| 2026-09-14 | マージに出す前の差分 | 5 件 | 5 件 |
| 2026-09-18 | セッション終了時の自動起動 | 6 件 | 0 件 |
| 2026-09-18 | 作業の振り返りそのもの | 9 件 | 5 件 |
